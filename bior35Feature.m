function Feature = bior35Feature(seg_image)

[c,s]=wavedec2(seg_image,4,'bior3.5');
%level-1
[H1,V1,D1] = detcoef2('all',c,s,1);
A1 = appcoef2(c,s,'bior3.5',1);
%level-2
[H2,V2,D2] = detcoef2('all',c,s,2);
A2 = appcoef2(c,s,'bior3.5',2);
%level-3
[H3,V3,D3] = detcoef2('all',c,s,3);
A3 = appcoef2(c,s,'bior3.5',3);
%level-4
[H4,V4,D4] = detcoef2('all',c,s,4);
A4 = appcoef2(c,s,'bior3.5',4);
